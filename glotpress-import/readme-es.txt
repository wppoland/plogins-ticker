...
* <strong>Documentation</strong> - https://plogins.com/es/plogins-ticker/docs/
* <strong>Plugin page</strong> - https://plogins.com/es/plogins-ticker/
...
= 0.1.2 =
* Añade la acción `ticker/countdown_rendered` y `data-ticker-product-id` en el marcado de cuenta regresiva para análisis PRO.

= 0.1.1 =
* Añade el filtro `ticker/end_timestamp` para que PRO y el código personalizado puedan anular la hora de finalización de la cuenta regresiva resuelta.

= 0.1.0 =
*Primer lanzamiento. Cuenta regresiva hasta la fecha de finalización de la venta de WooCommerce de un producto o la fecha de la campaña en toda la tienda, con ubicación configurable, tres formatos de hora, un encabezado opcional y un mensaje personalizado de finalización de la venta. Renderizado en servidor, sin jQuery, sin cambios de diseño.
</contenido>
</invocar>
